...
export function ReviewPanel({ projectId }: { projectId: string }): React.ReactNode {
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 px-4 py-3">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="ml-auto text-xs font-medium text-gray-500 dark:text-gray-400 underline hover:text-gray-700"
        >
      ...
      {canAct && (
        <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-3">
            <label htmlFor="score" className="block text-xs font-semibold uppercase text-gray-500 dark:text-gray-400">
              Grade
            </label>
            <div className="mt-1 flex items-center gap-2">
              <input
                ...
                placeholder="0"
                className="w-24 rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-1.5 text-sm focus:border-transparent focus:ring-2 focus:ring-indigo-500"
              />
              <span className="text-sm text-gray-500 dark:text-gray-400">/ {submission.assignment.max_score}</span>
            ...
            <p className="mt-2 text-xs font-semibold uppercase text-gray-500 dark:text-gray-400">Summary (optional)</p>
            <div className="mt-1">
        ...
        <div className="mt-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-3">
          {!showReopenForm ? (
            <button
              ...
              className="text-xs font-medium text-gray-600 dark:text-gray-400 underline hover:text-gray-800"
            >
            ...
            <>
              ...
              <textarea
                ...
                className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-1.5 text-sm focus:border-transparent focus:ring-2 focus:ring-indigo-500"
              />
