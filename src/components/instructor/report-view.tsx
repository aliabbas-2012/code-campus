            ...
            <tbody className="divide-y divide-gray-100">
              {rows?.map((r) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-700">{r.assignment_title}</td>
                  <td className="px-4 py-3 text-gray-600">{STATUS_LABELS[r.status] ?? r.status}</td>
                  <td className="px-4 py-3 text-gray-600">{r.score !== null ? `${r.score}/${r.max_score}` : '—'}</td>
